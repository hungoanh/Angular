  ...
  dishes: Dish[] = [
    {
      ...
      description:'A unique combination of Indian Uthappam \
        (pancake) and Italian pizza, topped with Cerignola olives, \
        ripe vine cherry tomatoes, Vidalia onion, Guntur chillies \
        and Buffalo Paneer.'
    },
   {
      name:'Zucchipakoda',
    ...
    },
   {
      ...
      description:'A delectable, semi-sweet New York Style \
        Cheese Cake, with Graham cracker crust and spiced with \
        Indian cardamoms'
    }
  ]
  constructor() { }
